    ...
    (<Link
      ...
      <div
        ...
        <div
          ...
          className="absolute left-1/2 top-1/2  flex justify-start items-start  rounded-2xl  shadow-[0_8px_16px_rgb(0_0_0/0.4)] bg-black  group-hover/pin:border-white/[0.2] transition duration-700 overflow-hidden">
...
export const PinPerspective = ({
  ...
  return (
    (<motion.div
      className="pointer-events-none  w-24 h-28 flex items-center justify-center opacity-0 group-hover/pin:opacity-100 z-[60] transition duration-500">
